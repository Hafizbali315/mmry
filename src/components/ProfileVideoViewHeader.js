...
import FavIconWhite from '../assets/images/fav-icon-white.png'
import LogoSmDark from '../assets/images/logo-sm-dark.png'
import LogoSmLight from '../assets/images/logo-sm-light.png'
import UserAvatar from '../assets/images/user-avatar.png'

const ProfileVideoViewHeader = () => {
	const [colorTheme, setTheme] = useDarkMode()

	return (
		<>
			{/* Desktop Header */}
			<header className="desktop-header light-header d-lg-block d-none">
				<nav className="navbar navbar-expand-lg navbar-light">
					<div className="container-fluid">
						<a href="home" className="navbar-brand">
							<img src={FavIconWhite} alt="logo" className="img-fluid" />
						</a>
						<button
						...
						<div className="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<ul className="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
								<li className="nav-item">
									<a className="nav-link ps-3 pe-0" href="#a">
								...
								<li className="nav-item border-end">
									...
									{/* <a className="nav-link" className="dark-mode-toggle"><i className="fas fa-toggle-on"></i></a>  */}
								</li>
...
export default ProfileVideoViewHeader
